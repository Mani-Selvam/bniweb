...
const ICON = {
  chapter: 'M3 21h18M5 21V7l7-4 7 4v14M9 9h2M9 13h2M9 17h2M13 9h2M13 13h2M13 17h2',
...
export default function Dashboard() {
  return (
    <RoleDashboard
      title="Dashboard"
      subtitle="Welcome back. Here's a snapshot of your network."
      statsConfig={(d) => [
        { key: 'totalChapters', label: 'Chapters', accent: '#6366f1', icon: ICON.chapter, value: d.totalChapters },
